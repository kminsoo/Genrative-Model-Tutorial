...
class Trainer:
    ...
    def start(self):
        ...
        start_epoch = opt.epoch_base # 1
        end_epoch = opt.epoch_base + opt.nepochs + opt.nepochs_decay - 1 # 200
        total_iter = opt.iter_base # 0
        ...
        for epoch in epoch_tqdm:
            ...
            if epoch % opt.save_epoch_freq == 0 or epoch == end_epoch:
                ...
                if self.task == 'distill' and self.opt.distiller in ['cycleganbest', 'cycleganbest_mi']:
